...
function PortraitHero({
  ...
  const role = settings?.hero_role || hero?.badge || "Architecture & Interior Design Studio";
  ...
  // Split studio name into two display lines (e.g. "Kim Design / Studio")
  ...
  return (
    <section className="relative px-4 md:px-6 pt-6 md:pt-8 pb-10 md:pb-14">
      <div className="relative mx-auto max-w-[1400px] overflow-hidden rounded-[28px] md:rounded-[36px] bg-[#0c0c0e] text-white min-h-[78vh] md:min-h-[86vh] flex flex-col">
        ...
        />
        {/* Bottom vignette */}
        <div aria-hidden className="absolute inset-x-0 bottom-0 h-40 pointer-events-none bg-gradient-to-t from-[#0c0c0e]/90 to-transparent" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-end px-6 md:px-12 pb-28 md:pb-32">
          ...
          >
            {email && (
              <a href={`mailto:${email}`} className="flex items-center gap-3 hover:text-amber-300 transition-colors">
            ...
            {insta && (
              <a href={insta} target="_blank" rel="noreferrer" className="flex items-center gap-3 hover:text-amber-300 transition-colors">
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-amber-400/15 text-amber-400">
                  <Linkedin size={13} />
                </span>
            ...
            {phone && (
              <a href={`tel:${phone}`} className="flex items-center gap-3 hover:text-amber-300 transition-colors">
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-amber-400/15 text-amber-400">
                  <PhoneIcon size={13} />
                </span>
                <span>{phone}</span>
